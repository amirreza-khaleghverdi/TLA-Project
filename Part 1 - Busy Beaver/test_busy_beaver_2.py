...
if __name__ == "__main__":
    def run(input_):
        ...
        bbeaver2.debug(w, step_limit=1000, part_3=True)
        print()
        # 6
        print("BB with 3 states")
        bbeaver3.debug(w, step_limit=1000, part_3=True)
        print()
        # 13
        print("BB with 4 states")
        bbeaver4.debug(w, step_limit=1000, part_3=True)
        print()
        # This machine runs for 47176870 steps, writing 4098 1s, and then halts. So BB(5) is at least 47176870
        print("BB with 5 states")
        bbeaver5.debug(w, step_limit=1000, part_3=True)
        print()
